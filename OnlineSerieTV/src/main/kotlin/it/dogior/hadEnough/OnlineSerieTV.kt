...
class OnlineSerieTV : MainAPI() {
    ...
    private suspend fun bypassUprot(link: String): String? {
        val proxyUrl = "https://online-serietv-proxy.onrender.com" // <-- Sostituisci con il tuo URL Render
        val fullUrl = "$proxyUrl/bypass?url=${link.encodeURL()}"
        val result = app.get(fullUrl, timeout = 10_000).text
...
// Funzione di estensione per codificare URL
